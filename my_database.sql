...
COPY projects (id, title, volunteer_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('projects_id_seq', 142, true);
...
SELECT pg_catalog.setval('volunteers_id_seq', 88, true);
...
--
-- Name: projects projects_volunteer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Guest
--

ALTER TABLE ONLY projects
    ADD CONSTRAINT projects_volunteer_id_fkey FOREIGN KEY (volunteer_id) REFERENCES volunteers(id);
